...
>
> **2026-08-05 改动**：[§7](worktree.md#7-worktree)、[§8.4](delivery.md#84-forge-层lib-forgesh)、[§12](scope.md#12-待定) 按三个 P0 的结论重写，
> 连带 §3 / [§5.3](agents.md#53-shift-的生命周期) / [§9.2](boundaries.md#92-外部副作用真正需要边界的部分) / [§11](scope.md#11-01-范围) / [附录 C](appendix.md#附录-c--脚本清单) 同步更新。
...
所以只读这一页就够你把 yan 的运作方式讲给别人听，只是讲不出细节。

章节编号一个都没有变，变的只是它们住在哪个文件里。比如讲 shift 生命周期的那一节仍然编号 5.3，现在可以在 [`agents.md`](agents.md) 里找到它。
